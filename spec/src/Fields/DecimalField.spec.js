define('spec/Fields/DecimalFieldTests', ['dojo/query','dojo/dom-attr','dojo/dom-class','argos/Fields/DecimalField'], function(query, domAttr, domClass, DecimalField) {
return describe('argos.Fields.DecimalField', function() {
